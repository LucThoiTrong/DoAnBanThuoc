          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/30.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Viên giải phóng có kiểm soát Harnal Ocas 0.4mg trị triệu chứng của đường tiểu dưới (3 vỉ x 10 viên)</h1>
              <ul class="product-details list-unstyled">
                ...
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">IreLand</span></li>
                <li><span class="detail-title">Xuất xứ thương hiệu:</span>
                  <span class="detail-info">Astellas Ireland Co</span></li>
              </ul>
              <!-- Giá cả -->
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Harnal Ocas 0.4mg là gì? </h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Harnal Ocas 0.4mg là viên giải phóng có kiểm soát, được sử dụng để điều trị triệu chứng của đường tiểu dưới liên quan đến tăng sản tuyến tiền liệt lành tính (BPH).
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần Harnal Ocas 0.4mg
                </h4>
                  ...
                  <p>Tá dược: Macrogol 8000, macrogol 7,000,000, magnesi stearat.</p>
                  <p>Bao phim: Opadry yellow 03F22733 gồm có hypromellose 6 mPa.s, macrogol 8000, oxic sắt, màu vàng E172</p>
                </section>
                <!-- Công dụng -->
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Thuốc Harnal Ocas 0.4mg
                </h4>
                  <ul class="mt-2">
                    <li><strong>Chỉ định</strong></li>
                    <li>Thuốc Harnal Ocas 0.4mg được chỉ định dùng trong trường hợp điều trị triệu chứng của đường tiểu dưới (LUTS) liên quan đến tăng sản tuyến tiền liệt lành tính (BPH).</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách sử dụng Thuốc Harnal Ocas 0.4mg
                </h4>
                  <ul class="mt-2">
                    <li><strong>Liều dùng</strong></li>
                    <li>1 viên mỗi ngày.</li>
                    <li>Không cần điều chỉnh liều ở bệnh nhân suy thận.
                    </li>
                    <li>Không cần điều chỉnh liều ở bệnh nhân suy gan nhẹ đến trung bình.
                    </li>
                    <li>Không có chỉ định liên quan nào đối với việc sử dụng viên nén Harnal OCAS 0.4mg ở trẻ em.
                    </li>
                    <li>Tính an toàn và hiệu quả của Tamsulosin ở trẻ em < 18 tuổi chưa được xác định.
                    </li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Rối loạn thị lực: Nhìn mờ, suy giảm thị lực.
                    <br>Rối loạn da và mô dưới da: Viêm da bong vảy, ban đỏ đa dạng.
                    <br>Rối loạn hô hấp, ngực và trung thất: Chảy máu cam.
                  </p>
                </section>
                <!-- Lưu ý -->
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 40){
  %>
  <div class="container">
