          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/19.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Viên nang Bổ Huyết Ích Não BDF Bidipha cải thiện trí nhớ, giảm chóng mặt ù tai (6 vỉ x 10 viên)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">6 vỉ x 10 viên</span></li>
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">BIDIPHAR</span></li>
              ...
              <script>
                function updatePrice(unit) {
                  ...
                  if (unit === "Hộp") {
                    ...
                    priceElement.textContent = "15.834";
                  }
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Viên nang Bổ Huyết Ích Não BDF Bidipha là gì? </h3>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần Viên nang Bổ Huyết Ích Não BDF Bidipha</h4>
                  <table class="table table-bordered mt-2">
                    ...
                    <tbody>
                      <tr>
                        <td>Cao khô Đương quy (Extractum Radix Angelicae siccum)</td>
                        <td>300mg</td>
                      </tr>
                    </tbody>
                    <tbody>
                  ...
                  <p>Tá dược: Lecithin, Magnesi stearat, Colloidal silicon 
                    dioxide, Calcium carbonat extra light, Dầu đậu nành, Gelatin, Glycerin, Đen 
                    oxid sắt, Nâu oxid sắt, Methylparaben (0,183 mg), Propylparaben (0,054 mg), 
                    Vanilin, Nước tinh khiết.</p>
                </section>
                <!-- Công dụng -->
                <section id="usage" class="mt-5">
                  <h4>Công dụng Viên nang Bổ Huyết Ích Não BDF Bidipha</h4>
                  <ul class="mt-2">
                    <strong>Chỉ định</strong>
                    <li>Điều trị các triệu chứng thiếu máu não: suy giảm trí nhớ, kém tập trung, 
                      hay gắt bẳn ở người lớn tuổi, ngủ gà ngủ gật, chóng mặt, nhức đầu, ù tai.</li>
                    <li>Cải thiện bệnh Alzheimer.</li>
                    <li>Làm tăng quãng đường đi không đau ở người rối loạn ngoại biên (chứng đi tập tễnh cách hồi).</li>
                    <li>Giảm chức năng não bộ: giảm trí nhớ, suy nhược thần kinh, di chứng não.</li>
                    <li>Rối loạn tuần hoàn máu ở mắt: thoái hóa điểm vàng ở người tuổi già.</li>
                    <li>Cải thiện hội chứng Raynaud.</li>

                    <strong>Chống chỉ định</strong>
                    <li>Người mẫn cảm với bất cứ thành phần nào của thuốc.</li>
                    <li>Trẻ em vì chưa có tài liệu chứng minh tính an toàn của thuốc.</li>
                    <li>Bệnh nhân sử dụng thuốc chống kết tập tiểu cầu (aspirin) hoặc thuốc chống đông máu (warfarin), 
                      bệnh nhân thiếu vitamin K.</li>
                    <li>Người đang xuất huyết.</li>
                    <li>Bệnh nhân bị động kinh vì có thể gây co giật.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Viên nang Bổ Huyết Ích Não BDF Bidipha</h4>
                  <ul class="mt-2">
                    <strong>Liều dùng:</strong>
                    <li>Rối loạn chức năng não: uống 1 – 2 viên/lần x 3 lần/ngày.</li>
                    <li>Rối loạn tuần hoàn ngoại biên: uống 1 viên/lần x 3 lần/ngày hoặc 
                      2 viên/ lần x 2 lần/ngày</li>
                    <br>Không dùng thay thế thuốc điều trị tăng huyết áp.
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <ul class="mt-2">
                    <li>Hiếm gặp: rối loạn tiêu hóa nhẹ, nhức đầu, chóng mặt, tim đập nhanh hoặc 
                      dị ứng (mẩn đỏ, sưng, ngứa).</li>
                    <li>Kéo dài thời gian chảy máu được ghi nhận ở một số trường hợp cá biệt sau 
                      khi điều trị dài ngày với các thuốc có thành phần chứa Ginkgo biloba.</li>
                  </ul>
                </section>
                <!-- Lưu ý -->
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 10){
  %>
  <div class="container">
