          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/11.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Dung dịch uống Cynamus CPC1 tiêu nhầy, loãng đàm, giảm ho (4 vỉ x 5 ống)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">4 vỉ x 5 ống</span></li>
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">DP Trung ương CPC1</span></li>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">66.000</span>
                ...
                <div class="unit-selector">
                  ...
                  <button class="btn unit-btn" data-unit="Ống" data-id-don-vi-tinh="4" onclick="updatePrice('Ống')">Ống</button>
                </div>
              </div>
              ...
              <script>
                function updatePrice(unit) {
                  ...
                  if (unit === "Hộp") {
                    ...
                    priceElement.textContent = "3.300";
                  }
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Dung dịch uống Cynamus CPC1 là gì?</h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Cynamus CPC1 là sản phẩm được sản xuất bởi Công ty 
                    Dược Phẩm CPC1, có thành phần chính là Carbocistein 
                    được chỉ định trong các trường hợp: ho có đờm, tăng 
                    tiết nhiều đờm và nhầy nhớt như trong Viêm phế quản 
                    cấp và mạn tính, hen phế quản và giãn phế quản.
                  </p>
                </section>
                <!-- Thành phần -->
                ...
                <section id="usage" class="mt-5">
                  ...
                  <ul class="mt-2">
                    ...
                    <li>Thuốc được chỉ định trong các trường hợp: Ho có đờm, 
                      tăng tiết nhiều đờm và nhầy nhớt như trong viêm phế quản cấp 
                      và mạn tính, hen phế quản và giãn phế quản.</li>
                    <strong>Chống chỉ định</strong>
                    <li>Quá mẫn cảm với bất kì thành phần nào của thuốc.</li>
                ...
                <section id="dosage" class="mt-5">
                  ...
                  <ul class="mt-2">
                    ...
                    <li>Trẻ em 2-5 tuổi: 1 ống/ lần x 4 lần/ ngày.</li>
                    <li>Trẻ em 5-12 tuổi: 2 ống/ lần x 3 lần/ ngày.</li>
                    <li>Trẻ em 12-18 tuổi: liều thông thường 20mg/kg thể trọng.</li>
                    <li>Người lớn: liều ban đầu là 2250mg/ngày, chia nhiều lần. 
                      Liều duy trì là 1500mg/ ngày đến khi đáp ứng tốt với thuốc.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Sử dụng thuốc Carbocistein thường ít gặp các tác 
                    dụng phụ, tuy nhiên có thể xảy ra hiện tượng không 
                    dung nạp thuốc ở đường tiêu hoá như đau dày, 
                    buồn nôn, nôn mửa, tiêu chảy, xuất huyết đường 
                    tiêu hóa

                    <br>Bên cạnh đó, có thể gặp một số tác dụng phụ 
                    khác của thuốc Carbocistein như phản ứng kiểu phản 
                    vệ, phát ban da, hồng ban da do dị ứng, hồng ban 
                    nhiễm sắc cố định, co thắt phế quản, đau cơ, chóng 
                    mặt, nhức đầu, tiểu không tự chủ, đánh trống ngực
                    
                    <br>Trong trường hợp tác dụng phụ nghiêm trọng, 
                    người bệnh cần ngưng sử dụng thuốc và đưa đến cơ 
                    sở y tế gần nhất để được xử trí kịp thời.</p>
                </section>
                <!-- Lưu ý -->
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 17) {
  %>
  <div class="container">
