          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/10.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Bột pha uống Macetux 200mg Hasan tiêu chất nhầy trong bệnh nhầy nhớt (30 gói x 1g)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">30 gói x 1g</span></li>
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">Hasan- Demarpharm</span></li>
              ...
              <script>
                function updatePrice(unit) {
                  ...
                  if (unit === "Hộp") {
                    priceElement.textContent = "60.500";
                  } else if (unit === "Gói") {
                    priceElement.textContent = "2.000";
                  }
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Bột pha uống Macetux 200mg Hasan là gì?</h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Thuốc cốm macetux acetylcystein 200mg hasan (h/30g/1gr) Macetux 200 chứa acetylcystein 
                    với hàm lượng 200mg, là loại thuốc tiêu đi các chất nhầy. Thuốc được dùng để điều trị 
                    các rối loạn tiết dịch phế quản, đặc biệt trong các rối loạn phế quản cấp tính, như 
                    viêm phế quản cấp và đợt cấp của bệnh phổi mạn tính.
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần Thuốc cốm macetux acetylcystein 200mg hasan</h4>
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng Thuốc cốm macetux acetylcystein 200mg hasan</h4>
                  <ul class="mt-2">
                    <strong>Chỉ định</strong>
                    <li>Điều trị rối loạn tiết dịch phế quản, đặc biệt trong các rối loạn phế quản 
                      cấp tính, như viêm phế quản cấp và đợt cấp của bệnh phổi mạn tính.</li>

                    <strong>Chống chỉ định</strong>
                    <li>Tiền sử hen (nguy cơ phản ứng co thắt phế quản với tất cả các dạng thuốc 
                      chứa acetylcystein). Quá mẫn với acetylcystein. Người quá mẫn với bất kỳ 
                      thành phần nào của thuốc Trẻ dưới 2 tuổi Người mắc các rối loạn di truyền 
                      hiếm gặp về không dung nạp galactose, thiếu hụt Lapp lactase hoặc kém hấp 
                      thu glucose – galactose.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Thuốc cốm macetux acetylcystein 200mg hasan</h4>
                  <ul class="mt-2">
                    <strong>Liều dùng:</strong>
                    <li>Người lớn và trẻ em trên 7 tuổi: 200 mg x 2- 3 lần/ ngày.</li>
                    <li>Trẻ em 2 – 7 tuổi: 200 mg x 2 lần/ ngày. Trẻ em dưới 2 tuổi: 100 mg x 2 lần/ ngày.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <ul class="mt-2">
                    <li>Rất hiếm: rối loạn tiêu hóa, viêm miệng, ù tai. Phản ứng quá mẫn: Co thắt phế quản, 
                      phù mạch, nổi mẫn và ngứa, hạ huyết áp hay đôi khi tăng huyết áp có thể xảy ra. 
                      Các tác dụng không mong muốn khác: Chứng đỏ bừng, buồn nôn và nôn, sốt, ngất, đổ 
                      mô hồi, đau khớp, nhìn mờ, rối loạn chức năng gan, nhiễm acid, co giật, ngừng hồ 
                      hấp hoặc ngừng tim.</li>
                  </ul>
                </section>
                <!-- Lưu ý -->
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 19) {
  %>
  <div class="container">
