          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/33.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Dung dịch uống A.T Ascorbic 100mg/5ml bổ sung vitamin C (30 ống x 10ml)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">30 ống x 10ml</span></li>
                ...
                <li><span class="detail-title">Xuất xứ thương hiệu:</span>
                  <span class="detail-info">An Thiên</span></li>
              </ul>
              <!-- Giá cả -->
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Siro A.T Ascorbic là gì?
                </h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    A.T Ascorbic syrup An Thiên 30 ống x 10ml - dung dịch uống của công ty cổ phần dược phẩm An Thiên, thành phần chính chứa vitamin C (ascorbic acid), là thuốc dùng để bổ sung vitamin C; phòng và điều trị bệnh scorbut.
                    A.T Ascorbic syrup An Thiên 30 ống x 10ml - dung dịch uống được bào chế dưới dạng dung dịch uống có màu vàng cam, hương cam; hộp 20 ống, hộp 30 ống, hộp 50 ống nhựa x 10 ml (đóng ống từ màng PVC/PE).
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần của Siro A.T Ascorbic
                </h4>
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Siro A.T Ascorbic
                </h4>
                  <ul class="mt-2">
                    <li><strong>Chỉ định</strong></li>
                    <li>Bổ sung vitamin C.</li>
                    <li>Phòng và điều trị bệnh scorbut.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Siro A.T Ascorbic
                </h4>
                  <ul class="mt-2">
                    ...
                    <li>Trẻ em:
                        ...
                        Phòng và điều trị bệnh scorbut: 100 - 300 mg/ngày có nghĩa là uống 1 - 3 ống hoặc gói/ngày, chia làm nhiều lần.</li>
                    <li>Người lớn:

                        Bổ sung vitamin C vào chế độ ăn: Thay đổi từ 50 - 200 mg/ngày có nghĩa là uống 1/2 - 2 ống hoặc gói/ngày.
                        
                        Phòng và điều trị bệnh scorbut: 100 - 250 mg/lần có nghĩa là uống 1 - 2,5 ống hoặc gói/lần, 1 - 2 lần/ngày.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Khi sử dụng thuốc A.T Ascorbic syrup An Thiên 30 ống X 10ml - dung dịch uống, bạn có thể gặp các tác dụng không mong muốn (ADR).

                    <br>Rối loạn tiêu hoá có thể xảy ra khi dùng liều cao vitamin C (từ 1 g hàng ngày trở lên).
                    
                    <br>Tăng oxalat niệu, buồn nôn, nôn, co cứng cơ bụng, mệt mỏi, mất ngủ hoặc buồn ngủ, thiếu máu tan máu có thế xảy ra khi dùng vitamin C.
                    
                    <br>Thông báo ngay cho bác sĩ hoặc dược sĩ những phản ứng có hại gặp phải khi sử dụng thuốc.
                ...
                <section id="storage" class="mt-5">
                  <h4>Cách bảo quản</h4>
                  <p>Vitamin C sẫm màu dần khi tiếp xúc với ánh sáng và trong quá trình bảo quản. Dung dịch vitamin C bị oxy hóa nhanh trong không khí và môi trường kiềm.

                    <br>Nơi khô ráo, tránh ánh sáng, nhiệt độ dưới 300C.
                    
                    <br>Hạn dùng: 24 tháng kể từ ngày sản xuất. Không dùng thuốc quá hạn dùng ghi trên bao bì.
                    </p>
                </section>
              </div>
            </div>
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 28){
  %>
  <div class="container">
