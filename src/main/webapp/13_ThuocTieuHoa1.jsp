          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/13.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Bột pha uống Bioflora 100mg trị tiêu chảy cấp ở trẻ em, người lớn (hộp 20 gói)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">Hộp 20 gói</span></li>
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">Biocodex, France Kisska Int. Ltd., UK</span></li>
                <li><span class="detail-title">Xuất xứ thương hiệu:</span>
                  <span class="detail-info">Bioflora</span></li>
              </ul>
              <!-- Giá cả -->
              <div class="d-flex align-items-center gap-2">
                <!-- Giá này sẽ được cập nhật theo javascript bên dưới -->
                <span id="product-price" class="product-price">119.990</span>
              ...
              <script>
                function updatePrice(unit) {
                  ...
                  if (unit === "Hộp") {
                    priceElement.textContent = "119.990";
                  } else if (unit === "Gói") {
                    priceElement.textContent = "6.000";
                  }
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Bột pha uống Bioflora 100mg là gì?</h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Thuốc Bioflora 100mg của Công ty sản xuất Biocodex (Pháp) 
                    có thành phần chính là Saccharomyces boulardii CNCM 
                    1 - 745, dùng để điều trị và ngăn ngừa bệnh tiêu chảy cấp tái phát.
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần Bột pha uống Bioflora 100mg</h4>
                  <table class="table table-bordered mt-2">
                    ...
                    <tbody>
                      <tr>
                        <td>Saccharomyces boulardii CNCM I-745</td>
                        <td>100mg</td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng Bột pha uống Bioflora 100mg</h4>
                  <ul class="mt-2">
                    <strong>Chỉ định</strong>
                    Thuốc Bioflora được chỉ định dùng trong các trường hợp sau:
                    <li>Điều trị tiêu chảy cấp ở người lớn và trẻ em kết hợp 
                      với bù nước bằng đường uống.</li>
                    <li>Ngăn ngừa tiêu chảy khi dùng kháng sinh.</li>
                    <li>Ngăn ngừa tái phát tiêu chảy do Clostridium difficile.</li>
                    <strong>Chống chỉ định</strong>
                    <li>Mẫn cảm với một trong các thành phần của thuốc.</li>
                    <li>Bệnh nhân đặt catheter tĩnh mạch trung ương.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách sử dụng Bột pha uống Bioflora 100mg</h4>
                  <strong>Liều dùng:</strong>
                  <p>Người lớn và trẻ em: 2 gói mỗi ngày, chia làm 2 lần.</p>
                </section>
                <!-- Lưu ý -->
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 6) {
  %>
  <div class="container">
