          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/12.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Siro Danospan 0.7g/100ml trị viêm đường hô hấp kèm ho, bệnh lý viêm phế quản mạn tính (chai 100ml)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">Chai 100ml</span></li>
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">Công ty cổ phần Dược DANAPHA</span></li>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">60.000</span>
                <span><span class="product-price"><u> đ</u></span>/</span>
                <div class="unit-selector">
                  <!-- active là nút sẽ hiện ban đầu khi nào, nút này khớp với giá bên trên -->
                  <button class="btn unit-btn active" data-unit="Hộp" data-id-don-vi-tinh="2" onclick="updatePrice('Hộp')">Hộp</button>                </div>
              </div>
              </script>
              <!-- Chọn số lượng -->
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Siro Danospan là gì?</h3>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần Siro Danospan</h4>
                  <table class="table table-bordered mt-2">
                    ...
                    <tbody>
                      <tr>
                        <td>Cao khô lá thường xuân</td>
                        <td>0,7g</td>
                      </tr>
                    </tbody>
                  </table>
                  <p>Tá dược: Kali sorbat, acid citric monohydrat, dung dịch 
                    sorbitol 70%, sucralose, xanthan gum, nước tinh khiết vừa đủ 100ml.</p>
                </section>
                <!-- Công dụng -->
                <section id="usage" class="mt-5">
                  <h4>Công dụng Siro Danospan</h4>
                  <ul class="mt-2">
                    <strong>Chỉ định</strong>
                    <li>Thuốc được dùng điều trị viêm đường hô hấp cấp tính có kèm ho, 
                      điều trị triệu chứng trong bệnh lý viêm phế quản mạn tính.</li>
                    <strong>Chống chỉ định</strong>
                    <li>Người bị mẫn cảm với các thành phần của thuốc.</li>
                    <li>Đối với những trường hợp bất dung nạp fructose, 
                      phụ nữ có thai hoặc đang cho con bú, chỉ được phép dùng 
                      thuốc theo sự chỉ dẫn của Bác sĩ.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách sử dụng Siro Danospan</h4>
                  <ul class="mt-2">
                    <strong>Cách dùng</strong>
                    <li>Sử dụng dụng cụ đong thuốc đi kèm trong hộp thuốc.</li>
                    <li>Lắc kỹ trước mỗi lần sử dụng.</li>
                    <strong>Liều dùng:</strong> 
                    <br>Nếu không có chỉ định riêng, sử dụng liều như sau:
                    <li>Trẻ sơ sinh -1 tuổi: 2,5ml x 1 - 2 lần/ngày.</li>
                    <li>Trẻ 1 tuổi - 4 tuổi: 2,5ml x 2 lần/ngày.</li>
                    <li>Trẻ em 12-18 tuổi: liều thông thường 20mg/kg thể trọng.</li>
                    <li>Trẻ 4 tuổi - 12 tuổi: 5ml x 2 lần/ngày.</li>
                    <li>Trẻ > 12 tuổi và người lớn: 5ml x 3 lần/ngày.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Rất hiếm khi, siro ho Danospan có thể dẫn tới 
                    nhuận tràng do thành phần sorbitol có trong thuốc.

                    <br>Thông báo cho Bác sĩ các tác dụng không mong 
                    muốn gặp phải khi sử dụng thuốc.</p>
                </section>
                <!-- Lưu ý -->
                <section id="warnings" class="mt-5">
                  <h4>Lưu ý</h4>
                  <p>
                    Không nên dùng thuốc quá hạn (có ghi rõ trên nhãn) 
                    hay có sự nghi ngờ về chất lượng thuốc.

                    <br>Đọc kĩ hướng dẫn sử dụng trước khi dùng. Muốn 
                    biết thêm thông tin xin hãy hỏi ý kiến của bác sĩ hoặc dược sĩ.

                    <br><strong>Lưu ý đặc biệt: </strong>
                    <br>Cũng như các chế phẩm có nguồn gốc chiết xuất 
                    từ thực vật, màu của si ro Danospan đôi khi có thể bị thay đổi. 
                    Tuy nhiên, điều này không ảnh hưởng đến hiệu quả điều trị của thuốc.

                    <br><strong>Sử dụng thuốc cho phụ nữ có thai và cho con bú: </strong>
                    <br>Mặc dù chưa có báo cáo nào về tác dụng không mong muốn đối với 
                    thai nhi và trẻ bú mẹ, chỉ nên sử dụng thuốc cho phụ nữ mang thai 
                    và cho con bú khi thật cần thiết. Cần cân nhắc giữa lợi ích 
                    mang lại và nguy cơ tác dụng không mong muốn có thể xảy ra.
                  </p>
                </section>
                <!-- Bảo quản -->
                <section id="storage" class="mt-5">
                  <h4>Cách bảo quản</h4>
                  <p>Trong bao bì kín, nơi khô, tránh ánh sáng. Nhiệt độ không quá 30°C.</p>
                </section>
              </div>
            </div>
          </div>
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 20) {
  %>
  <div class="container">
