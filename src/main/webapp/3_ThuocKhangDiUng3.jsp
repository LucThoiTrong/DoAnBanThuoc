          ...
          <div class=" row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/3.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Siro Lorastad SP STELLA điều trị dị ứng (chai 60ml)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">Chai 60ml</span></li>
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">STELLA</span></li>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">15.000</span>
                <span><span class="product-price"><u> đ</u></span>/</span>
                <div class="unit-selector">
                  <!-- active là nút sẽ hiện ban đầu khi nào, nút này khớp với giá bên trên -->
                  <button class="btn unit-btn active" data-unit="Hộp" onclick="updatePrice('Chai')">Hộp</button>
                </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Siro Lorastad SP STELLA là gì?</h3>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần Siro Lorastad SP STELLA</h4>
                  ...
                  <p>Tá dược: Glycerin, acid citric khan, natri benzoat, saccharose, propylen glycol, 
                    mùi dâu nước, nước tinh khiết</p>
                </section>
                <!-- Công dụng -->
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Siro Lorastad SP STELLA</h4>
                  <ul class="mt-2">
                    <strong>Chỉ định</strong>
                    <li>Giảm triệu chứng của dị ứng bao gồm viêm mũi và mày đay mạn tính.</li>
                ...
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Siro Lorastad SP STELLA</h4>
                  <ul class="mt-2">
                    Lorastad Sp. được dùng bằng đường uống.
                    <br><strong>Liều dùng:</strong>
                    <li>Người lớn và trẻ em trên 12 tuổi: 10ml x 1 lần/ ngày.</li>
                    <li>Trẻ em từ 2 - 5 tuổi: 5ml/ngày.</li>
                    <li>Trẻ em từ 6 - 12 tuổi; 10ml/ngày.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <ul class="mt-2">
                    <li>Thường gặp: đau đầu, khô miệng.</li>
                    <li>Ít gặp: chóng mặt, khô mũi và hắt hơi, viêm kết mạc.</li>
                  </ul>
                </section>
                <!-- Lưu ý -->
