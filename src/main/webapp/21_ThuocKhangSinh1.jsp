          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/21.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Bột pha uống Binozyt 200mg/5ml điều trị nhiễm khuẩn đường hô hấp (chai 15ml)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">Hộp 1 lọ 15ml</span></li>
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">Romania</span></li>
                <li><span class="detail-title">Xuất xứ thương hiệu:</span>
                  <span class="detail-info">Glenmark</span></li>
              </ul>
              <!-- Giá cả -->
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Bột pha uống Binozyt 200mg/5ml là gì?</h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>Binozyt là sản phẩm của Sandoz, thành phần chính là Azithromycin. 
                    Thuốc được sử dụng điều trị các nhiễm khuẩn sau đây, gây ra bởi các vi 
                    khuẩn nhạy cảm với azithromycin: Viêm xoang cấp tính do vi khuẩn, viêm tai giữa cấp tính 
                    do vi khuẩn, viêm họng, viêm amidan, đợt cấp tính của viêm phế quản 
                    mạn tính, viêm phổi mắc phải tại cộng đồng từ nhẹ đến trung bình, nhiễm khuẩn 
                    da và mô mềm, nhiễm khuẩn đường niệu và cổ tử cung không biến chứng do Chlamydia trachomatis.
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần của Bột pha uống Binozyt 200mg/5ml</h4>
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Bột pha uống Binozyt 200mg/5ml</h4>
                  <ul class="mt-2">
                    <li><strong>Chỉ định</strong></li>
                    <li>Thuốc Binozyt được chỉ định dùng trong các trường hợp sau:
                        Azithromycin được sử dụng điều trị các nhiễm khuẩn sau đây, gây ra bởi các vi khuẩn nhạy 
                        cảm với azithromycin (xem mục Thận trọng và cảnh báo đặc biệt khi sử dụng và Dược lực học):
                        Viêm xoang cấp tính do vi khuẩn (đã được chẩn đoán đầy đủ).
                        Viêm tai giữa cấp tính do vi khuẩn (đã được chẩn đoán đầy đủ).
                        Viêm họng, viêm amidan. Đợt cấp tính của viêm phế quản mạn tính (đã được chẩn đoán đầy đủ).
                        Viêm phổi mắc phải tại cộng đồng từ nhẹ đến trung bình.
                        Nhiễm khuẩn da và mô mềm. Nhiễm khuẩn đường niệu và cổ tử cung không biến chứng do Chlamydia trachomatis.
                    </li>
                    <li><strong>Chống chỉ định</strong></li>
                    <li>Quá mẫn với bất kì thành phần nào của thuốc.</li>
                ...
                <section id="dosage" class="mt-5">
                  ...
                  <ul class="mt-2">
                    ...
                    <li>Người lớn: Đối với nhiễm khuẩn đường niệu và cổ tử cung do Chlamydia trachomatis uống 1 liều duy nhất 1000 mg.
                        Đối với các chỉ định khác tổng liều là 1500 mg, dùng 500 mg/ngày trong 3 ngày liên tiếp. Hoặc tổng liều (1500 mg) có thể dùng trong 5 ngày với 500 mg ngày đầu tiên và 250 mg từ ngày thứ 2 đến ngày thứ 5.</li>
                    <li>Trẻ em và thanh thiếu niên (< 18 tuổi):
                        Tổng liều ở trẻ em từ 1 tuổi trở lên là 30 mg/kg được uống 10 mg/kg mỗi ngày một lần trong 3 ngày, hoặc trong 5 ngày với liều duy nhất 10 mg/kg trong ngày đầu tiên, liều tiếp theo 5 mg/kg mỗi ngày trong 4 ngày tiếp theo, theo bảng dưới đây. Dữ liệu hạn chế đối với sử dụng cho trẻ dưới 1 tuổi.</li>
                    <li>Người cao tuổi:
                        Dùng liều giống như người lớn. Do các bệnh nhân cao tuổi có thể đi kèm với tình trạng tiền loạn nhịp tiến triển nên cần thận trọng với các bệnh nhân này do nguy cơ bị loạn nhịp tim và xoắn đỉnh.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Khi sử dụng thuốc thường gặp các tác dụng không mong muốn (ADR) như:
                    <br>Bảng dưới đây liệt kê các tác dụng bất lợi theo hệ cơ quan và tần suất được xác định trong các thử nghiệm lâm sàng và theo dõi sau khi đưa thuốc ra thị trường. Tần suất theo nhóm được định nghĩa theo quy ước sau:
                    <br>Phổ biến (≥ 1/10); thường gặp (≥ 1/100 đến < 1/10); ít gặp (≥ 1/1000 đến < 1/100); hiếm gặp (≥ 1/10000 đến < 1/1000); rất hiếm gặp (< 1/10000); và chưa rõ (không thể ước tính dựa trên các dữ liệu hiện có).
                    <br>Trong mỗi nhóm tần suất, tác dụng bất lợi được trình bày theo thứ tự giảm dần mức độ nghiêm trọng.</p>
                </section>
                <!-- Lưu ý -->
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 29){
  %>
  <div class="container">
