          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/9.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Bột pha uống Acehasan 200mg tiêu chất nhầy trong bệnh nhầy nhớt (30 gói x 3g)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">30 gói x 3g</span></li>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">31.550</span>
              ...
              <script>
                function updatePrice(unit) {
                  ...
                  if (unit === "Hộp") {
                    ...
                    priceElement.textContent = "1.050";
                  }
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Bột pha uống Acehasan 200mg là gì?</h3>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần Bột pha uống Acehasan 200mg</h4>
                  ...
                  Tá dược: Vitamin C, Saccharose, Natri saccharin, Kollidon K30, Mùi cam.
                </section>
                <!-- Công dụng -->
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Bột pha uống Acehasan 200mg</h4>
                  <ul class="mt-2">
                    <strong>Chỉ định</strong>
                    <li>Thuốc Acehasan 100 làm loãng đờm trong các bệnh phế quản - phổi cấp 
                      và mãn tính kèm theo sự tăng tiết chất nhầy. Dùng làm thuốc giải độc 
                      trong quá liều paracetamol.</li>

                    <strong>Chống chỉ định</strong>
                    <li>Với trẻ em dưới 2 tuổi Quá mẫn với Acetylcystein hay bất cứ thành 
                      phần nào khác của thuốc Tiền sử hen (do nguy cơ phản ứng co thắt phế 
                      quản với tất cả các dạng thuốc có chứa Acetylcystein).</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Bột pha uống Acehasan 200mg</h4>
                  <ul class="mt-2">
                    <strong>Liều dùng:</strong>
                    <li>Người lớn và trẻ em trên 6 tuổi uống 3 lần trong một ngày với hàm lượng là 200mg 
                      cho một lần uống.</li>
                    <li>Trẻ em từ 2 đến 6 tuổi uống 2 lần trong ngày cũng với hàm lượng là 200mg cho một 
                      lần uống.</li>
                    <li>Giải độc quá liều paracetamol: Khởi đầu với hàm lượng 140 mg/kg, dùng dung dịch 
                      5% tiếp theo cách 4 giờ uống 1 lần, liều 70 mg/kg thể trọng và uống tổng cộng thêm 
                      17 lần.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <ul class="mt-2">
                    <li>Rất hiếm khi xảy ra: Buồn nôn, nhức đầu, viêm miệng, ù tai, phát ban, mày đay.</li>
                  </ul>
                </section>
                <!-- Lưu ý -->
                ...
                <section id="storage" class="mt-5">
                  <h4>Cách bảo quản</h4>
                  <p>Thuốc nên được bảo quản ở nơi khô, nhiệt độ dưới 30°C và tránh ẩm.</p>
                </section>
              </div>
            </div>
          </div>
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 18) {
  %>
  <div class="container">
