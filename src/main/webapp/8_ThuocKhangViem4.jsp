          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/8.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Viên nén Cetirizine EG Pymepharco 10mg trị triệu chứng viêm mũi dị ứng, mày đay (10 vỉ x 10 viên)</h1>
              <ul class="product-details list-unstyled">
                ...
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">Pymepharco</span></li>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">45.000</span>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Cetirizine EG Pymepharco là gì?</h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Cetirizine EG Pymepharco là thuốc viên nén có thành phần chính là Cetirizine 
                    dihydrochloride 10mg. Thuốc được dùng để điều trị các triệu chứng viêm mũi 
                    dị ứng và mày đay.
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần Cetirizine EG Pymepharco</h4>
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Cetirizine EG Pymepharco</h4>
                  <ul class="mt-2">
                    <strong>Chỉ định</strong>
                    <li>Điều trị triệu chứng viêm mũi dị ứng dai dẳng và theo mùa.</li>
                    <li>Điều trị mày đay mạn tính vô căn ở người lớn và trẻ em trên 12 tuổi.</li>
                    <li>Điều trị viêm kết mạc dị ứng.</li>

                    <strong>Chống chỉ định</strong>
                    <li>Không dùng cho những người có tiền sử dị ứng với Cetirizine hoặc Hydroxyzine.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Cetirizine EG Pymepharco</h4>
                  <ul class="mt-2">
                    <strong>Liều dùng:</strong>
                    <li>Người lớn và trẻ em từ 6 tuổi trở lên: Liều khởi đầu đề nghị là 5 mg 
                      hoặc 10 mg mỗi ngày, tùy theo mức độ nghiêm trọng của triệu chứng.</li>
                    <li>Bệnh nhân suy gan hoặc suy thận: Giảm liều còn 1/2 liều thường dùng.</li>
                    <li>Người từ 77 tuổi trở lên: Liều khuyến cáo là 5 mg mỗi ngày.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <ul class="mt-2">
                    <li>Thường gặp: Ngủ gà, mệt mỏi, khô miệng, viêm họng, chóng mặt, nhức đầu, buồn nôn.</li>
                    <li>Ít gặp: Chán ăn hoặc tăng thèm ăn, bí tiểu, đỏ bừng, tăng tiết nước bọt.</li>
                  </ul>
                </section>
                <!-- Lưu ý -->
                ...
                <section id="storage" class="mt-5">
                  <h4>Cách bảo quản</h4>
                  <p>Nơi khô thoáng, tránh ẩm, tránh ánh sáng trực tiếp.</p>
                </section>
              </div>
            </div>
          </div>
