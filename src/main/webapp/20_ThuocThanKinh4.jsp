          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/20.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Viên nén Hoạt Huyết Nhất Nhất giúp hoạt huyết, trị thiểu năng tuần hoàn (3 vỉ x 10 viên)</h1>
              <ul class="product-details list-unstyled">
                ...
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">Công ty TNHH Dược phẩm Nhất Nhất</span></li>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">115.000</span>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Hoạt Huyết Nhất Nhất là gì?</h3>
                <!-- Mô tả -->
                <section id="description" class="mt-4">
                  <h4>Mô tả</h4>
                  <p>
                    Hoạt Huyết Nhất Nhất là một loại thuốc đông y được bào chế từ các thành 
                    phần thảo dược tự nhiên, có tác dụng hoạt huyết, dưỡng não, cải thiện 
                    tuần hoàn máu và giảm các triệu chứng như đau đầu, chóng mặt, mất ngủ, 
                    và suy giảm trí nhớ.
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần Hoạt Huyết Nhất Nhất</h4>
                  <table class="table table-bordered mt-2">
                    ...
                    <tbody>
                      <tr>
                        <td>Đương quy (Radix Angelicae sinensis)</td>
                        <td>1500mg</td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        <td>Ích mẫu (Herba Leonuri japonica)</td>
                        <td>1500mg</td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        <td>Ngưu tất (Radix Achyranthis bidentatae)</td>
                        <td>1500mg</td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        <td>Thục địa (Radix Rehmanniae glutinosae praeparata)</td>
                        <td>1500mg</td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        <td>Xích thược (Radix Paeoniae)</td>
                        <td>750mg</td>
                      </tr>
                    </tbody>
                    <tbody>
                      <tr>
                        <td>Xuyên khung (Rhizoma Ligustici wallichii)</td>
                        <td>750mg</td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng Hoạt Huyết Nhất Nhất</h4>
                  <ul class="mt-2">
                    <strong>Chỉ định</strong>
                    <li>Thuốc có tác dụng bổ huyết, hoạt huyết. Dùng để trị các chứng huyết hư, 
                      ứ trệ. Phòng ngừa và điều trị thiểu năng tuần hoàn não 
                      (mệt mỏi, đau đầu, chóng mặt, mất thăng bằng, hoa mắt, mất ngủ, 
                      suy giảm trí nhớ, suy nhược thần kinh), thiểu năng tuần hoàn ngoại vi 
                      (đau mỏi vai gáy, tê cứng cổ, đau cách hồi, đau cơ, tê bì chân tay) thể huyết ứ. 
                      Hỗ trợ phòng ngừa và điều trị xơ vữa động mạch, bệnh mạch vành, nghẽn mạch, tai 
                      biến mạch máu não.</li>

                    <strong>Chống chỉ định</strong>
                    <li>Phụ nữ có thai, người đang chảy máu.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Hoạt Huyết Nhất Nhất</h4>
                  <ul class="mt-2">
                    Cách dùng: Uống nguyên viên thuốc với một ly nước, không nghiền nát hoặc 
                    nhai viên thuốc.
                    <br><strong>Liều dùng:</strong>
                    <li>Ngày uống 2 lần, mỗi lần 2 viên.</li>
                    <li>Với bệnh mãn tính nên uống thuốc liên tục ít nhất 3 tháng.</li>
                    <br>Chú ý: Với từng bệnh nhân cụ thể, nếu hiệu quả, Hoạt huyết Nhất 
                    Nhất phải có tác dụng rõ rệt sau 10 - 15 ngày sử dụng, nếu không thì 
                    nên ngưng dùng để khỏi lãng phí.
                    <br>Nên tránh dùng những thuốc hoặc thực phẩm gì khi đang sử dụng thuốc 
                    này: hạn chế ăn nhiều chất béo.
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                ...
                <section id="storage" class="mt-5">
                  <h4>Cách bảo quản</h4>
                  <p>Bảo quản nơi khô ráo, thoáng mát, tránh ánh sáng trực tiếp và nhiệt độ cao.</p>
                </section>
              </div>
            </div>
          </div>
