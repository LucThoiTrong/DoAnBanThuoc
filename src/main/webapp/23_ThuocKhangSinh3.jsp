          ...
          <div class=" row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/23.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Bột pha uống Cefdinir 125mg S.Pharm kháng sinh điều trị nhiễm khuẩn (30 gói x 1,5g)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">30 gói x 1, 5g</span></li>
                ...
                <li><span class="detail-title">Xuất xứ thương hiệu:</span>
                  <span class="detail-info">Công ty cổ phần dược S.Pharm</span></li>
              </ul>
              <!-- Giá cả -->
              <div class="d-flex align-items-center gap-2">
                <!-- Giá này sẽ được cập nhật theo javascript bên dưới -->
                <span id="product-price" class="product-price">145.000</span>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Thuốc Cefdinir 125 - MV là gì?</h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Thuốc Cefdinir 125-MV là sản phẩm của US Pharma USA, chứa dược chất chính là cefdinir – 
                    kháng sinh cephalosporin thế hệ thứ 3, được dùng để trị các trường hợp nhiễm khuẩn nhẹ 
                    đến vừa, gây ra bởi những vi khuẩn nhạy cảm.
                  </p>
                </section>
                <!-- Thành phần -->
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Thuốc Cefdinir 125 - MV</h4>
                  <ul class="mt-2">
                    <li><strong>Chỉ định</strong></li>
                    <li>Viêm phổi mắc phải cộng đồng do các tác nhân Haemophilus influenzae, Moraxella catarrhalis (gồm cả chủng sinh beta-lactamase), Streptococcus pneumoniae (chủng nhạy cảm với penicillin)..</li>
                    <li>Đợt cấp của viêm phế quản mạn cũng do các tác nhân Haemophilus influenzae, Moraxella catarrhalis (gồm cả chủng sinh beta-lactamase), Streptococcus pneumoniae (chủng nhạy cảm với penicillin).</li>
                    <li>Viêm xoang cấp tính do Haemophilus influenzae, Moraxella catarrhalis (gồm cả chủng sinh beta-lactamase) và Streptococcus pneumoniae (chủng nhạy cảm với penicillin).</li>
                    <li>Viêm hầu họng/ viêm amiđan do Streptococcus pyogenes.
                        Nhiễm khuẩn da và cấu trúc da: Do Staphylococcus aureus (gồm cả chủng sinh beta-lactamase) và Streptococcus pyogenes.
                        Viêm tai giữa cấp gây ra bởi Haemophilus influenzae, Moraxella catarrhalis (gồm cả chủng sinh beta-lactamase), Streptococcus pneumoniae.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Thuốc Cefdinir 125 - MV</h4>
                  <ul class="mt-2">
                    <li><strong>Liều dùng</strong></li>
                    <li>Thời gian điều trị từ 5 - 10 ngày tùy trường hợp, có thể dùng 1 lần/ngày hay chia 2 lần/ngày.</li>
                    <li>Người lớn và trẻ em trên 13 tuổi: 300 mg x 2 lần/ngày hay 600 mg/1 lần/ngày. Tổng liều là 600 mg cho các loại nhiễm trùng.</li>
                    <li>Trẻ em từ 6 tháng đến 12 tuổi: 7mg/kg x 2 lần/ngày hoặc 14mg/kg/ngày.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Khi sử dụng thuốc Cefdinir 125-MV, bạn có thể gặp các tác dụng không mong muốn (ADR).
                    <br>Hiếm khi: Tiêu chảy, buồn nôn, nhức đầu, đau bụng, nổi mẩn, viêm âm đạo.
                    <br>Rất hiếm: Khó tiêu, đầy hơi, nôn mửa, biếng ăn, táo bón, phần khác thường, suy nhược, chóng mặt, mất ngủ, ngứa ngáy, ngủ gà.                   
                    <br>Hướng dẫn cách xử trí ADR:  
                    Khi gặp tác dụng phụ của thuốc, cần ngưng sử dụng và thông báo cho bác sĩ hoặc đến cơ sở y tế gần nhất để được xử trí kịp thời.</p>
                </section>
                <!-- Lưu ý -->
                ...
                <section id="storage" class="mt-5">
                  <h4>Cách bảo quản</h4>
                  <p>Bảo quản thuốc ở nơi khô thoáng, nhiệt độ dưới 30oC, tránh ánh sáng.</p>
                </section>
              </div>
            </div>
          </div>
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 32){
  %>
  <div class="container">
