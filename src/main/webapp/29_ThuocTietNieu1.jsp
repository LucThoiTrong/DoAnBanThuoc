          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/29.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Viên bao đường Domitazol Domesco hỗ trợ điều trị nhiễm trùng đường tiết niệu dưới (5 vỉ x 10 viên)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">5 vỉ x 10 viên</span></li>
                ...
                <li><span class="detail-title">Xuất xứ thương hiệu:</span>
                  <span class="detail-info">Domesco</span></li>
              </ul>
              <!-- Giá cả -->
              <div class="d-flex align-items-center gap-2">
                <!-- Giá này sẽ được cập nhật theo javascript bên dưới -->
                <span id="product-price" class="product-price">125.000</span>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Thuốc Domitazol là gì?
                </h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Thuốc Domitazol® do Công ty Cổ phần Xuất Nhập khẩu Y tế Domesco sản xuất, với thành phần chính gồm: 
                    Bột hạt Malva (Malva purpurea), Xanh methylene, Camphor monobromide. Domitazol® là thuốc được dùng hỗ trợ điều trị 
                    nhiễm trùng đường tiết niệu dưới không có biến chứng.
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần của Thuốc Domitazol
                </h4>
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Thuốc Domitazol </h4>
                  <ul class="mt-2">
                    <li><strong>Chỉ định</strong></li>
                    <li>Thuốc Domitazol® được chỉ định dùng để hỗ trợ điều trị nhiễm trùng đường tiết niệu dưới không có biến chứng.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Thuốc Domitazol
                </h4>
                  <ul class="mt-2">
                    <li><strong>Liều dùng</strong></li>
                    <li>Dùng cho người lớn 6 - 9 viên, chia làm 3 lần/ngày.</li>
                    <li><strong>Lưu ý: Liều dùng trên chỉ mang tính chất tham khảo. Liều dùng cụ thể tùy thuộc vào thể trạng và mức độ diễn tiến của bệnh. Để có liều dùng phù hợp, bạn cần tham khảo ý kiến bác sĩ hoặc chuyên viên y tế.</strong></li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Khi sử dụng thuốc Domitazol®, bạn có thể gặp các tác dụng không mong muốn (ADR) như: Thiếu máu, tan máu, buồn nôn, nôn, đau bụng, tiêu chảy, chóng mặt, đau đầu, sốt, tăng huyết áp, đau vùng trước tim, nóng rát hầu họng, mê sảng, co giật cơ, co giật kiểu động kinh, trầm cảm của hệ thần kinh trung ương. Kích ứng bàng quang, tiểu khó, nước tiểu nhuộm màu xanh do xanh methylen. Da có màu xanh.</p>
                </section>
                <!-- Lưu ý -->
                ...
                <section id="storage" class="mt-5">
                  <h4>Cách bảo quản</h4>
                  <p>Bảo quản nơi khô, dưới 30°C, tránh ánh sáng trực tiếp.</p>
                </section>
              </div>
            </div>
          </div>
