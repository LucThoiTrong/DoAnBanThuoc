          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/25.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Viên nén Arimidex 1mg điều trị ung thư vú (2 vỉ x 14 viên)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">2 vỉ x 14 viên</span></li>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">155.000</span>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Thuốc Arimidex 1mg là gì?
                </h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Arimidex là sản phẩm của AstraZeneca Pharmaceuticals LP USA có thành phần chính là Anastrozole hỗ trợ cho phụ nữ sau mãn kinh bị ung thư vú giai đoạn sớm có thụ thể estrogen dương tính.
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần của Thuốc Arimidex 1mg
                </h4>
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Thuốc Arimidex 1mg</h4>
                  <ul class="mt-2">
                    <li><strong>Chỉ định</strong></li>
                    <li>Điều trị hỗ trợ cho phụ nữ sau mãn kinh bị ung thư vú giai đoạn sớm có thụ thể estrogen dương tính.</li>
                    <li>Điều trị ung thư vú tiến triển ở phụ nữ sau mãn kinh. Ở những bệnh nhân có thụ thể estrogen âm tính, hiệu quả của thuốc chưa được chứng minh trừ phi các bệnh nhân này đã có đáp ứng tích cực trên lâm sàng với tamoxifen trước đó.</li>
                    <li>Điều trị hỗ trợ cho phụ nữ sau mãn kinh bị ung thư vú giai đoạn sớm có thụ thể estrogen dương tính, là những bệnh nhân đã được điều trị hỗ trợ bằng tamoxifen trong 2 đến 3 năm.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Thuốc Arimidex 1mg
                </h4>
                  <ul class="mt-2">
                    <li><strong>Liều dùng</strong></li>
                    <li>Người lớn, kể cả người cao tuổi: 1 viên 1 mg uống ngày 1 lần.</li>
                    <li>Trẻ em: Không được khuyến cáo dùng.</li>
                    <li>Tổn thương chức năng thận: Không cần thay đổi liều lượng ở bệnh đã nhân có tổn thương chức năng thận nhẹ hoặc trung bình.
                    </li>
                    <li>Tổn thương chức năng gan: Không cần thay đổi liều lượng ở bệnh nhân có bệnh lý gan nhẹ.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Trừ phi có ghi chú thêm, những tần xuất phân loại dưới đây được tính từ số biến cố ngoài ý được ghi nhận trong 1 nghiên cứu lớn pha III tiến hành trên 9366 phụ nữ sau mãn kinh bị ung thư vú có thể phẫu thuật đã dùng thuốc trong 5 năm nghiên cứu ATAC).
                    <br>*Xuất huyết âm đạo thường được ghi nhận, chủ yếu ở bệnh nhân ung thư vú tiến triển trong vài tuần đầu tiên sau khi chuyển từ liệu pháp nội tiết tố sang điều trị bằng Arimidex. Cần đánh giá thêm nếu hiện tượng xuất huyết vẫn còn.

                    <br>** Trong các nghiên cứu lâm sàng, hội chứng ống cổ tay đã được báo cáo ở bệnh nhân điều trị với Arimidex nhiều hơn so với những bệnh 3 nhân điều trị với tamoxifen. Tuy nhiên, phần lớn hội chứng này xuất hiện ở bệnh nhân có các yếu tố nguy cơ rõ rệt để phát triển bệnh.

                    <br>Vì Arimidex làm giảm nồng độ estrogen trong máu nên có thể gây giảm mật độ khoáng của xương làm cho một số bệnh nhân có nguy cơ cao bị gãy xương.
                  </p>
                </section>
                <!-- Lưu ý -->
                <section id="warnings" class="mt-5">
                  <h4>Lưu ý</h4>
                  <p>Trước khi sử dụng thuốc bạn cần đọc kỹ hướng dẫn sử dụng và tham khảo thông tin bên dưới.
                  </p>
                </section>
                <!-- Bảo quản -->
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 33){
  %>
  <div class="container">
