          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/6.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Viên nang Long Huyết P/H điều trị sưng đau, bầm tím, phù nề, chấn thương do va đập (2 vỉ x 12 viên)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">2 vỉ x 12 viên</span></li>
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">Dong Duoc Phuc Hung</span></li>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">48.000</span>
              ...
              <script>
                function updatePrice(unit) {
                  ...
                  if (unit === "Hộp") {
                    priceElement.textContent = "48.000";
                  } else if (unit === "Vỉ") {
                    priceElement.textContent = "24.000";
                  }
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Viên nang Long Huyết P/H là gì?</h3>
                <!-- Mô tả -->
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Thuốc Long Huyết P/H của Công ty TNHH Đông dược Phúc Hưng, với thành phần chính 
                    cao khô huyết giác (Lignum Dracaenae cambodianae). Long Huyết là phần thân hóa 
                    gỗ màu đỏ của cây Dracaenae cambodianae già cỗi, sống hàng trăm năm trên các núi 
                    đá. Từ lâu nó đã được biết đến như là vị thuốc quý bí truyền của các võ sư, thầy 
                    thuốc dùng đặc trị nội, ngoại thương như: Giảm đau, cầm máu, giúp nhanh liền vết 
                    thương do dao kiếm, các chấn thương do va đập mạnh gây bầm dập, tụ máu, sưng đau...
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần của Viên nang Long Huyết P/H</h4>
                  <table class="table table-bordered mt-2">
                    ...
                    <tbody>
                      <tr>
                        <td>Cao khô Huyết giác (Lignum Dracaenae cambodianae)</td>
                        <td>280mg</td>
                      </tr>
                    </tbody>
                  </table>
                  <p>Tá dược: talc vừa đủ 1 viên.</p>
                </section>
                <!-- Công dụng -->
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Viên nang Long Huyết P/H</h4>
                  <ul class="mt-2">
                    <strong>Chỉ định</strong>
                    <li>Vết thương hở ngoài da như: Vết trầy xước, vết cắt sâu do dao kiếm, tai nạn gây ra. 
                      Giúp vị trí tổn thương mau khô - tiêu sưng, chống phù nề một cách hiệu quả, nhanh 
                      liền sẹo.</li>
                    <li>Vết thương do phẫu thuật: Kết hợp sử dụng Long huyết P/H trong quá trình điều trị 
                      giúp nhanh phục hồi.</li>
                    <li>Trị mụn nhọt, vết loét lâu ngày không khỏi.</li>
                    <li>Sưng đau, bầm tím, bong gân, chấn thương do va đập, bị đòn, té ngã, tai nạn lao 
                      động, giao thông, luyện tập thể thao. Giúp giảm đau và làm tan nhanh các vết bầm 
                      tím.</li>

                    <strong>Chống chỉ định</strong>
                    <li>Thuốc Long Huyết P/H chống chỉ định cho phụ nữ có thai.</li>
                    <li>Phụ nữ mang thai và cho con bú.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách sử dụng Viên nang Long Huyết P/H</h4>
                  <ul class="mt-2">
                    Thuốc Long Huyết P/H dùng uống sau bữa ăn từ 1 - 2 giờ.
                    <br><strong>Liều dùng:</strong>
                    <li>Người lớn: Ngày uống 3 lần mỗi lần 4 viên.</li>
                    <li>Trẻ em: Uống 1/2 liều của người lớn.</li>
                  </ul>
                ...
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <ul class="mt-2">
                    <li>Cho đến nay, vẫn chưa có tài liệu nào báo cáo về tác dụng không mong muốn 
                      của thuốc.</li>
                  </ul>
                  <p>Nếu bạn gặp phải bất kỳ tác dụng không mong muốn nào, hãy ngưng dùng thuốc 
                    và thông báo ngay cho bác sĩ hoặc đến ngay cơ sở y tế gần nhất để được xử trí 
                    kịp thời.</p>
                </section>
                <!-- Lưu ý -->
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 12) {
  %>
  <div class="container">
