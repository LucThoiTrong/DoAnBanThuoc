          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/35.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Dung dịch uống Conipa Pure 70mg phòng ngừa và điều trị thiếu kẽm (4 vỉ x 5 ống)</h1>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">85.000</span>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Dung dịch uống Conipa CPC1 Hà Nội là gì?
                ...
                <section id="description" class="mt-5">
                  <h4>Mô tả</h4>
                  <p>
                    Dung dịch Conipa bổ sung kẽm cho cơ thể, giúp tăng cường sức đề kháng cho cơ thể. Bổ sung cho chế độ ăn thiếu kẽm hoặc cơ thể kém hấp thu kẽm.
                  </p>
                </section>
                <!-- Thành phần -->
                <section id="composition" class="mt-4">
                  <h4>Thành phần của Dung dịch uống Conipa CPC1 Hà Nội
                </h4>
                  <table class="table table-bordered mt-2">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Magnesi pidolat</td>
                        <td>26mg</td>
                      </tr>
                    </tbody>
                  </table>
                  <p>Kẽm: Là một khoáng chất thiết yếu tham gia vào rất nhiều thành phần các enzym trong cơ thể. Kẽm giúp duy trì hoạt động hiệu quả của hệ thống miễn dịch, ảnh hưởng đến sự tăng trưởng về thể chất và hoạt động tinh thần.

                    <br>Manganese và magnesium: Là 2 nguyên tố vi lượng cần thiết cho nhiều loại enzym cho các phản ứng oxy hóa khử gốc tự do gây độc cho cơ thể, đặc biệt là các enzym sử dụng ATP. Không đủ magiê trong cơ thể sinh ra các chứng co thắt cơ, và nó liên quan đến các chứng bệnh tim mạch, đái đường, huyết áp cao và loãng xương. Khi kết hợp với kẽm sẽ làm tăng quá trình oxy hóa khử, tăng khả năng miễn dịch của cơ thể.</p>
                </section>
                <!-- Công dụng -->
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Dung dịch uống Conipa CPC1 Hà Nội
                </h4>
                  <ul class="mt-2">
                    <li>Dung dịch Conipa bổ sung kẽm cho cơ thể, giúp tăng cường sức đề kháng cho cơ thể.
                    </li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  ...
                  <ul class="mt-2">
                    ...
                    <li>Trẻ từ 14 - 15 tuổi: 2 - 3 ống, chia 2 - 3 lần/ngày.
                    </li>
                    <li>Trẻ từ 9 - 13 tuổi: 2 ống, chia 2 lần/ngày.
                    </li>
                    <li>Trẻ từ 4 - 8 tuổi: 1 ống/ngày.</li>
                    <li>Trẻ từ 2 - 3 tuổi: 1/2 ống/ngày.
                    </li>
                    <li>Trẻ < 2 tuổi: Tham khảo ý kiến bác sĩ, dược sĩ trước khi dùng.
                    </li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 27){
  %>
  <div class="container">
