          ...
          <div class=" row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/26.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Viên nén Nolvadex-D 20mg điều trị ung thư vú (3 vỉ x 10 viên)</h1>
              ...
              <div class="d-flex align-items-center gap-2">
                ...
                <span id="product-price" class="product-price">75.000</span>
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                ...
                <section id="composition" class="mt-4">
                  <h4>Thành phần của Viên nén Nolvadex-D </h4>
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Viên nén Nolvadex-D</h4>
                  <ul class="mt-2">
                    <li><strong>Chỉ định</strong></li>
                    <li>Nolvadex-D chỉ định dùng điều trị ung thư vú.</li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Viên nén Nolvadex-D
                </h4>
                  <ul class="mt-2">
                    <li><strong>Liều dùng</strong></li>
                    <li>Người lớn (kể cả người cao tuổi): Liều dùng từ 20 đến 40 mg/ngày, uống một lần duy nhất hoặc chia làm hai lần. Liều khuyến cáo là 20mg/ngày. Liều 40mg/ngày chỉ sử dụng khi bệnh nhân không đáp ứng với liều 20mg/ngày.</li>
                    <li>Sử dụng cho trẻ em: Không khuyến cáo sử dụng Nolvadex-D cho trẻ em vì hiệu quả và tính an toàn chưa được thiết lập.
                    </li>
                ...
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Tác dụng phụ của Nolvadex-D có thể phân loại theo tác động dược lý của thuốc như nóng bừng mặt, xuất huyết âm đạo, tiết dịch âm đạo, ngứa âm hộ và phản ứng da xung quanh bướu hay theo tác dụng ngoại ý thường gặp như rối loạn tiêu hóa, nhức đầu, chóng mặt và ít gặp hơn là ứ dịch cơ thể và rụng tóc.

                    <br>Khi các tác dụng phụ này nặng, có thể xử trí bằng cách giảm liều (đến mức không dưới 20mg/ngày) mà không ảnh hưởng đến việc kiểm soát bệnh. Nếu các tác dụng phụ không giảm khi giảm liều, có thể cần phải ngưng trị liệu.
                    
                    <br>Nổi mẩn ở da (kể cả các trường hợp hiếm gặp như ban đỏ đa dạng, hội chứng Stevens-Johnson, viêm mao mạch da, dạng pemphigut bọng nước) và các phản ứng quá mẫn, kể cả phù mạch cũng thường được ghi nhận.
                    
                    <br>Ít gặp trường hợp bệnh nhân di căn xương bị tăng canxi trong máu khi bắt đầu điều trị.
                    
                    Hiện tượng giảm tiểu cầu, thường giảm còn 80.000 đến 90.000/mm3, đôi khi thấp hơn, được ghi nhận ở bệnh nhân ung thư vú điều trị bằng tamoxifen.</p>
                </section>
                <!-- Lưu ý -->
                ...
                <section id="storage" class="mt-5">
                  <h4>Cách bảo quản</h4>
                  <p>Để nơi mát, tránh ánh sáng, nhiệt độ dưới 30⁰C.
                  </p>
                </section>
              </div>
            </div>
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 36){
  %>
  <div class="container">
