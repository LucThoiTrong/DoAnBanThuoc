          ...
          <div class="row p-4 border rounded shadow bg-white">
            ...
            <div class="product-image-section col-lg-5 col-md-6 mb-4">
              <div class="product-main-image">
                <img src="imageMedicine/34.png" alt="Img" class="img-fluid rounded">
              </div>
            </div>

            <!-- Phần thông tin sản phẩm -->
            <div class="product-info-section col-lg-7 col-md-6">
              <h1>Dung dịch uống Aquadetrim D3 điều trị thiếu vitamin D (chai 10ml)</h1>
              <ul class="product-details list-unstyled">
                <li><span class="detail-title">Quy cách:</span> 
                  <span class="detail-info">Chai 10ml</span></li>
                <li><span class="detail-title">Nơi sản xuất:</span> 
                  <span class="detail-info">Ba Lan</span></li>
                <li><span class="detail-title">Xuất xứ thương hiệu:</span>
                  <span class="detail-info">Medana Pharma</span></li>
              </ul>
              <!-- Giá cả -->
              <div class="d-flex align-items-center gap-2">
                <!-- Giá này sẽ được cập nhật theo javascript bên dưới -->
                <span id="product-price" class="product-price">200.000</span>
          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div class="content p-4 bg-light rounded shadow-sm">
                <h3>Dung dịch uống Aquadetrim Vitamin D3 là gì?
                </h3>
                <!-- Mô tả -->
                ...
                <section id="usage" class="mt-5">
                  <h4>Công dụng của Dung dịch uống Aquadetrim Vitamin D3</h4>
                  <ul class="mt-2">
                    <li><strong>Chỉ định</strong></li>
                    <li>Phòng ngừa bệnh còi xương và loãng xương ở trẻ em và người lớn.</li>
                    <li>Phòng ngừa bệnh còi xương ở trẻ sơ sinh sinh non.
                    </li>
                    <li>Phòng ngừa thiếu hụt vitamin D ở trẻ em và người lớn có nguy cơ nhất định.
                    </li>
                    <li>Phòng ngừa thiếu hụt vitamin D ở trẻ em và người lớn bị kém hấp thu.
                    </li>
                    <li>Điều trị bệnh còi xương và loãng xương ở trẻ em và người lớn.
                    </li>
                    <li>Điều trị giảm năng tuyến cận giáp ở người lớn.
                    </li>
                  </ul>
                </section>
                <!-- Cách dùng -->
                <section id="dosage" class="mt-5">
                  <h4>Cách dùng Dung dịch uống Aquadetrim Vitamin D3
                </h4>
                  <ul class="mt-2">
                    <li><strong>Liều dùng</strong></li>
                    <li>Phòng thiếu hụt:

                        Trẻ em từ sơ sinh và người lớn: 500 IU (1 giọt) mỗi ngày.</li>
                    <li>Điều trị thiếu hụt:

                        Liều lượng nên do bác sỹ quyết định cho từng bệnh nhân tùy theo mức độ thiếu.</li>
                    <li>Điều trị còi xương phụ thuộc Vitamin D:

                        Trẻ em: 3.000 IU đến 10.000 IU (6 đến 20 giọt) mỗi ngày.</li>
                    <li>Điều trị loãng xương do dùng các thuốc chống co giật:

                        Trẻ em: 1.000 IU (2 giọt) mỗi ngày.
                        
                        Người lớn: 1.000 đến 4.000 IU (2 đến 8 giọt) mỗi ngày.</li>
                  </ul>
                </section>
                <!-- Tác dụng phụ -->
                <section id="side-effects" class="mt-5">
                  <h4>Tác dụng phụ</h4>
                  <p>Thực tế không xảy ra tác dụng phụ khi dùng liều khuyến nghị. Trong trường hợp hiếm bị mẫn cảm với vitamin D3 hoặc khi dùng liều quá cao trong thời gian dài, ngộ độc vitamin D có thể xảy ra. Các triệu chứng của nhiễm độc bao gồm:

                    <br>Rối loạn tim mạch: Loạn nhịp tim;
                    <br>Rối loạn hệ thần kinh: Đau đầu, hôn mê;
                    <br>Rối loạn mắt: Viêm kết mạc, sợ ánh sáng;
                    <br>Rối loạn tiêu hóa: Chán ăn, buồn nôn, nôn, táo bón;
                    <br>Rối loạn thần và tiết niệu: Urê huyết, đa niệu, sỏi thận;
                    <br>Rối loạn cơ xương và mô liên kết: Đau cơ và khớp, nhược cơ;
                    <br>Rối loạn dinh dưỡng và chuyển hóa: Tăng calci máu, tăng calci niệu, tăng cholesterol máu, giảm cân, tăng tiết mồ hôi, viêm tụy;
                    <br> Rối loạn mạch: Tăng huyết áp;
                    <br>Rối loạn gan mật: Tăng hoạt động enzym aminotransferase;
                    <br>Rối loạn da và mô dưới da: Mày đay, ban, ngứa;
                    <br>Rối loạn tâm thần: Giảm ham muốn tình dục, trầm cảm, rối loạn tinh thần;
                    Ngoài ra còn có thể có tác dụng không mong muốn sau: Chảy nước mũi, tăng thân nhiệt, khô miệng và calci hóa mô.</p>
                </section>
                <!-- Lưu ý -->
                ...
                <section id="storage" class="mt-5">
                  <h4>Cách bảo quản</h4>
                  <p>Bảo quản ở nhiệt độ dưới 30°C, nơi khô ráo. Không làm lạnh hoặc làm đông thuốc. Để trong bao bì gốc nhằm tránh ánh sáng.
                  </p>
                </section>
              </div>
            </div>
...
<div class="reviews-container">
  <% for (DanhGia dg : danhGiaSet) {
    ...
    if (dg.getSanPham() != null && dg.getSanPham().getId() == 25){
  %>
  <div class="container">
